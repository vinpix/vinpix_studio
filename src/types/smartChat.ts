...
export interface ChatAttachment {
  ...
  // `pinned` marks a reference that rode along from a previous turn (pinned in
  // the composer) rather than being attached fresh this turn.
  sourceRefs?: { key?: string; name?: string; pinned?: boolean }[];
}
