        ...
        <div className="mt-10 space-y-8 text-base sm:text-lg leading-relaxed">
          ...
          <section>
            ...
            <p className="opacity-90 mb-3">
              Permission is granted to temporarily use KitchenTogether for
          ...
          <section>
            ...
            <p className="opacity-90">
              ...
              are and will remain the exclusive property of KitchenTogether and
          ...
          <section>
            ...
            <p className="opacity-90">
              In no event shall KitchenTogether, nor its directors, employees,
          ...
          <section>
            ...
            <p className="opacity-90">
              ...
              jurisdiction in which KitchenTogether operates, without regard to
